...
class ChatViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if cell.senderUsername.text == Auth.auth().currentUser?.email as String? {
            ...
            cell.avatarImageView.image = #imageLiteral(resourceName: "girl")
        } else {
            
            cell.imageView?.backgroundColor = UIColor.yellow
            cell.messageBackground.backgroundColor = UIColor.lightGray
            cell.avatarImageView.image = #imageLiteral(resourceName: "boy")
    ...
    @IBAction func logOutPressed(_ sender: AnyObject) {
        ...
        // signout with firebase methods
        do { try Auth.auth().signOut() }
        catch { print("error, in Signing Out") }
